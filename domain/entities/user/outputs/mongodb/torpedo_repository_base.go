...
// mongoDBRepositoryBase MongoDB repository implements user.IRepositoryBase
...
func (r *mongoDBRepositoryBase) Save(entity *user.UserEntity) error {
...
func (r *mongoDBRepositoryBase) FetchByID(id string) (*user.UserEntity, error) {
	h := r.hooks.FetchById()
...
func (r *mongoDBRepositoryBase) Update(entity *user.UserEntity) error {
...
func (r *mongoDBRepositoryBase) Query(q *tql.Query, metadata map[string]string) ([]*user.UserEntity, error) {
