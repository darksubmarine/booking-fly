...
// mongoDBRepositoryBase MongoDB repository implements trip.IRepositoryBase
...
func (r *mongoDBRepositoryBase) Save(entity *trip.TripEntity) error {
...
func (r *mongoDBRepositoryBase) FetchByID(id string) (*trip.TripEntity, error) {
	h := r.hooks.FetchById()
...
func (r *mongoDBRepositoryBase) Update(entity *trip.TripEntity) error {
...
func (r *mongoDBRepositoryBase) DeleteByUser(userId string) error {
	filter := bson.D{{"userId", userId}}
	h := r.hooks.DeleteBy()
	h.BeforeDeleteBy("user", userId)
...
func (r *mongoDBRepositoryBase) Query(q *tql.Query, metadata map[string]string) ([]*trip.TripEntity, error) {
