...
type iServiceCreateHooks interface {
	beforeCreate(ctx context.IDataMap, entity *TripEntity) error
	afterCreate(ctx context.IDataMap, entity *TripEntity) error
}

type iServiceReadHooks interface {
	beforeRead(ctx context.IDataMap, id string) error
	afterRead(ctx context.IDataMap, entity *TripEntity) error
}

type iServiceUpdateHooks interface {
	beforeUpdate(ctx context.IDataMap, entity *TripEntity) error
	afterUpdate(ctx context.IDataMap, entity *TripEntity) error
}
...
func (n *noopServiceHooks) beforeCreate(ctx context.IDataMap, entity *TripEntity) error { return nil }
func (n *noopServiceHooks) afterCreate(ctx context.IDataMap, entity *TripEntity) error  { return nil }

func (n *noopServiceHooks) beforeUpdate(ctx context.IDataMap, entity *TripEntity) error { return nil }
func (n *noopServiceHooks) afterUpdate(ctx context.IDataMap, entity *TripEntity) error  { return nil }
...
func (n *noopServiceHooks) afterRead(ctx context.IDataMap, entity *TripEntity) error { return nil }
